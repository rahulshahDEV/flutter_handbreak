...
void main() {
  group('ResolutionCalculator', () {
    test('preserves aspect for maxWidth constraint', () {
      final r = ResolutionCalculator.calculate(
        srcWidth: 3840,
        srcHeight: 2160,
        maxWidth: 1920,
      );
    ...
    test('progress clamping', () {
      expect(
        ResolutionCalculator.progress(encodedFrames: 50, totalFrames: 100),
        0.5,
      );
      expect(
        ResolutionCalculator.progress(encodedFrames: 150, totalFrames: 100),
        1.0,
      );
      expect(
        ResolutionCalculator.progress(encodedFrames: 0, totalFrames: 0),
        0.0,
      );
    });
    test('estimatedTotalFrames', () {
      expect(
        ResolutionCalculator.estimateTotalFrames(durationMs: 10000, fps: 30),
        300,
      );
      expect(
        ResolutionCalculator.estimateTotalFrames(durationMs: 0, fps: 30),
        0,
      );
    });
  });
